...
import (
	...
	"github.com/MagnoBelloni/FullCycleImersao17/payment/internal/entity"
	"github.com/MagnoBelloni/FullCycleImersao17/payment/pkg/rabbitmq"
...
func main() {
	...
	go rabbitmq.Consume(ch, msgs, "microservico-pagamentos")
